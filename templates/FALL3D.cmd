...
#BSUB -n ${NTASKS}
#BSUB -cwd ${RUNDIR}
#BSUB -oo ${LOGDIR}/FALL3D_%J.out
#BSUB -eo ${LOGDIR}/FALL3D_%J.err
#BSUB -J FALL3D
#BSUB -W 01:00
#BSUB -q xlarge
#BSUB -x
...
echo "$(date '+%d/%m/%Y %H:%M:%S'): Starting FALL3D" >> ${PRJDIR}/status.log
...
echo "$(date '+%d/%m/%Y %H:%M:%S'): FALL3D Done" >> ${PRJDIR}/status.log
