...
#BSUB -n ${NTASKS}
#BSUB -cwd ${RUNDIR}
#BSUB -oo ${LOGDIR}/FALL3D_POS_%J.out
#BSUB -eo ${LOGDIR}/FALL3D_POS_%J.err
#BSUB -J FALL3D_POS
#BSUB -w 'done(FALL3D)'
#BSUB -W 01:00
#BSUB -q xlarge
...
echo "$(date '+%d/%m/%Y %H:%M:%S'): Starting FALL3D_POS" >> ${PRJDIR}/status.log
...
echo "$(date '+%d/%m/%Y %H:%M:%S'): FALL3D_POS Done" >> ${PRJDIR}/status.log
